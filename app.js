...
async function getRandomImage(keyword, count) {
    return new Promise (function (resolve, reject) {
        let requestUrl = `https://api.unsplash.com/photos/random/?count=${count}&client_id=Zg-LSJulCgnp4W1Nl0IWOEaEQe6CZbza-Mjx836Wu7A&featured=true&orientation=landscape&query=${keyword}`;
